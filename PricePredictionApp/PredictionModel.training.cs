    ...
    public partial class PredictionModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=13,NumberOfIterations=38,MinimumExampleCountPerLeaf=24,LearningRate=0.0832419855712567,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features",ExampleWeightColumnName=null,Booster=new GradientBooster.Options(){SubsampleFraction=0.000183271001766549,FeatureFraction=0.711444853995954,L1Regularization=9.3363015952707E-09,L2Regularization=0.206528796096965},MaximumBinCountPerFeature=991}));
